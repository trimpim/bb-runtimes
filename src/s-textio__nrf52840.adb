...
--  Minimal version of Text_IO body for use on nRF52840, using USART1

with Interfaces; use Interfaces;

with Interfaces.NRF52;       use Interfaces.NRF52;
with Interfaces.NRF52.RCC;   use Interfaces.NRF52.RCC;
with Interfaces.NRF52.GPIO;  use Interfaces.NRF52.GPIO;
with Interfaces.NRF52.USART; use Interfaces.NRF52.USART;
with System.NRF52;           use System.NRF52;
...
package body System.Text_IO is
   ...
   procedure Initialize is
      ...
      APB_Clock    : constant Positive := Positive (NRF52.System_Clocks.PCLK2);
