...
--  This file provides register definitions for the NRF52 (ARM Cortex M4)
--  microcontrollers from ST Microelectronics.

with Interfaces.NRF52;

package System.NRF52 is
   pragma No_Elaboration_Code_All;
   pragma Preelaborate (System.NRF52);

   subtype Frequency is Interfaces.NRF52.UInt32;
   ...
   --  MODER constants
   subtype GPIO_MODER_Values is Interfaces.NRF52.UInt2;
   ...
   --  OTYPER constants
   subtype GPIO_OTYPER_Values is Interfaces.NRF52.Bit;
   Push_Pull  : constant GPIO_OTYPER_Values := 0;
   Open_Drain : constant GPIO_OTYPER_Values := 1;

   --  OSPEEDR constants
   subtype GPIO_OSPEEDR_Values is Interfaces.NRF52.UInt2;
   ...
   --  PUPDR constants
   subtype GPIO_PUPDR_Values is Interfaces.NRF52.UInt2;
   No_Pull   : constant GPIO_PUPDR_Values := 0;
   Pull_Up   : constant GPIO_PUPDR_Values := 1;
   Pull_Down : constant GPIO_PUPDR_Values := 2;

   --  AFL constants
   AF_USART1  : constant Interfaces.NRF52.UInt4 := 7;
   AF_USART6  : constant Interfaces.NRF52.UInt4 := 8;

   type MCU_ID_Register is record
      DEV_ID   : Interfaces.NRF52.UInt12;
      Reserved : Interfaces.NRF52.UInt4;
      REV_ID   : Interfaces.NRF52.UInt16;
   ...
   DEV_ID_NRF52820 : constant := 16#413#; --  BRF52820
   DEV_ID_NRF52832 : constant := 16#419#; --  BRF52832
   DEV_ID_NRF52840 : constant := 16#434#; --  BRF52840
