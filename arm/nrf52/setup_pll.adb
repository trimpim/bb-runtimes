...
--  with Interfaces.NRF52;           use Interfaces, Interfaces.NRF52;
--  with Interfaces.NRF52.FLASH;     use Interfaces.NRF52.FLASH;
...
--      RCC_Periph.APB1RSTR.PWRRST := 0;
      ...
      --  See table "General operating conditions" of the NRF52 datasheets
