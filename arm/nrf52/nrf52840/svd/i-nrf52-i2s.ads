...
package Interfaces.NRF52.I2S is
   pragma Preelaborate;
   ...
   type INTEN_Register is record
      ...
      --  Enable or disable interrupt for RXPTRUPD event
      RXPTRUPD      : INTEN_RXPTRUPD_Field := Interfaces.NRF52.I2S.Disabled;
      --  Enable or disable interrupt for STOPPED event
      STOPPED       : INTEN_STOPPED_Field := Interfaces.NRF52.I2S.Disabled;
      --  unspecified
      Reserved_3_4  : Interfaces.NRF52.UInt2 := 16#0#;
      --  Enable or disable interrupt for TXPTRUPD event
      TXPTRUPD      : INTEN_TXPTRUPD_Field := Interfaces.NRF52.I2S.Disabled;
      --  unspecified
   ...
   type ENABLE_Register is record
      --  Enable I2S module.
      ENABLE        : ENABLE_ENABLE_Field := Interfaces.NRF52.I2S.Disabled;
      --  unspecified
   ...
   type MODE_CONFIG_Register is record
      --  I2S mode.
      MODE          : MODE_MODE_Field := Interfaces.NRF52.I2S.Master;
      --  unspecified
      Reserved_1_31 : Interfaces.NRF52.UInt31 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   type RXEN_CONFIG_Register is record
      --  Reception (RX) enable.
      RXEN          : RXEN_RXEN_Field := Interfaces.NRF52.I2S.Disabled;
      --  unspecified
      Reserved_1_31 : Interfaces.NRF52.UInt31 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   type TXEN_CONFIG_Register is record
      --  Transmission (TX) enable.
      TXEN          : TXEN_TXEN_Field := Interfaces.NRF52.I2S.Enabled;
      --  unspecified
      Reserved_1_31 : Interfaces.NRF52.UInt31 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   type MCKEN_MCKEN_Field is
     (
      --  Master clock generator disabled and PSEL.MCK not connected(available
      --  as GPIO).
      Disabled,
   ...
   type MCKEN_CONFIG_Register is record
      --  Master clock generator enable.
      MCKEN         : MCKEN_MCKEN_Field := Interfaces.NRF52.I2S.Enabled;
      --  unspecified
      Reserved_1_31 : Interfaces.NRF52.UInt31 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   type RATIO_CONFIG_Register is record
      --  MCK / LRCK ratio.
      RATIO         : RATIO_RATIO_Field := Interfaces.NRF52.I2S.Val_256X;
      --  unspecified
   ...
   type SWIDTH_CONFIG_Register is record
      --  Sample width.
      SWIDTH        : SWIDTH_SWIDTH_Field := Interfaces.NRF52.I2S.Val_16Bit;
      --  unspecified
   ...
   type ALIGN_CONFIG_Register is record
      --  Alignment of sample within a frame.
      ALIGN         : ALIGN_ALIGN_Field := Interfaces.NRF52.I2S.Left;
      --  unspecified
      Reserved_1_31 : Interfaces.NRF52.UInt31 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   type FORMAT_CONFIG_Register is record
      --  Frame format.
      FORMAT        : FORMAT_FORMAT_Field := Interfaces.NRF52.I2S.I2S;
      --  unspecified
      Reserved_1_31 : Interfaces.NRF52.UInt31 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   type CHANNELS_CONFIG_Register is record
      --  Enable channels.
      CHANNELS      : CHANNELS_CHANNELS_Field := Interfaces.NRF52.I2S.Stereo;
      --  unspecified
      Reserved_2_31 : Interfaces.NRF52.UInt30 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   type CONFIG_Cluster is record
      ...
      MCKFREQ  : aliased Interfaces.NRF52.UInt32;
      --  MCK / LRCK ratio.
   ...
   subtype MAXCNT_RXTXD_MAXCNT_Field is Interfaces.NRF52.UInt14;
   ...
   subtype MCK_PSEL_PIN_Field is Interfaces.NRF52.UInt5;
   subtype MCK_PSEL_PORT_Field is Interfaces.NRF52.Bit;
   ...
   type MCK_PSEL_Register is record
      ...
      --  unspecified
      Reserved_5_7  : Interfaces.NRF52.UInt3 := 16#7#;
      --  Port number
      PORT          : MCK_PSEL_PORT_Field := 16#1#;
      --  unspecified
      Reserved_9_30 : Interfaces.NRF52.UInt22 := 16#3FFFFF#;
      --  Connection
      CONNECT       : MCK_CONNECT_Field := Interfaces.NRF52.I2S.Disconnected;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type SCK_PSEL_Register is record
      ...
      Reserved_9_30 : Interfaces.NRF52.UInt22 := 16#3FFFFF#;
      --  Connection
      CONNECT       : SCK_CONNECT_Field := Interfaces.NRF52.I2S.Disconnected;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype LRCK_PSEL_PIN_Field is Interfaces.NRF52.UInt5;
   subtype LRCK_PSEL_PORT_Field is Interfaces.NRF52.Bit;
   ...
   type LRCK_PSEL_Register is record
      ...
      Reserved_9_30 : Interfaces.NRF52.UInt22 := 16#3FFFFF#;
      --  Connection
      CONNECT       : LRCK_CONNECT_Field := Interfaces.NRF52.I2S.Disconnected;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype SDIN_PSEL_PIN_Field is Interfaces.NRF52.UInt5;
   subtype SDIN_PSEL_PORT_Field is Interfaces.NRF52.Bit;
   ...
   type SDIN_PSEL_Register is record
      ...
      Reserved_9_30 : Interfaces.NRF52.UInt22 := 16#3FFFFF#;
      --  Connection
      CONNECT       : SDIN_CONNECT_Field := Interfaces.NRF52.I2S.Disconnected;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype SDOUT_PSEL_PIN_Field is Interfaces.NRF52.UInt5;
   subtype SDOUT_PSEL_PORT_Field is Interfaces.NRF52.Bit;
   ...
   type SDOUT_PSEL_Register is record
      ...
      Reserved_9_30 : Interfaces.NRF52.UInt22 := 16#3FFFFF#;
      --  Connection
      CONNECT       : SDOUT_CONNECT_Field :=
                       Interfaces.NRF52.I2S.Disconnected;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type I2S_Peripheral is record
      ...
      --  pin.
      EVENTS_RXPTRUPD : aliased Interfaces.NRF52.UInt32;
      ...
      --  pin.
      EVENTS_TXPTRUPD : aliased Interfaces.NRF52.UInt32;
      --  Enable or disable interrupt
