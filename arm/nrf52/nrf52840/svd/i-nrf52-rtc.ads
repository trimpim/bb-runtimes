...
package Interfaces.NRF52.RTC is
   ...
   --  Description collection[0]: Compare event on CC[0] match
   type EVENTS_COMPARE_Registers is array (0 .. 3) of Interfaces.NRF52.UInt32
     with Volatile;
   ...
   type RTC_Peripheral is record
      ...
      TASKS_TRIGOVRFLW : aliased Interfaces.NRF52.UInt32;
      --  Event on COUNTER increment
      EVENTS_TICK      : aliased Interfaces.NRF52.UInt32;
      --  Event on COUNTER overflow
      EVENTS_OVRFLW    : aliased Interfaces.NRF52.UInt32;
      --  Description collection[0]: Compare event on CC[0] match
