...
package Interfaces.NRF52.QDEC is
   pragma Preelaborate;
   ...
   type SHORTS_Register is record
      ...
      REPORTRDY_READCLRACC : SHORTS_REPORTRDY_READCLRACC_Field :=
                              Interfaces.NRF52.QDEC.Disabled;
      --  Shortcut between SAMPLERDY event and STOP task
   ...
   type ENABLE_Register is record
      --  Enable or disable the quadrature decoder
      ENABLE        : ENABLE_ENABLE_Field := Interfaces.NRF52.QDEC.Disabled;
      --  unspecified
   ...
   type LEDPOL_Register is record
      --  LED output pin polarity
      LEDPOL        : LEDPOL_LEDPOL_Field := Interfaces.NRF52.QDEC.Activelow;
      --  unspecified
      Reserved_1_31 : Interfaces.NRF52.UInt31 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   type SAMPLEPER_Register is record
      ...
      SAMPLEPER     : SAMPLEPER_SAMPLEPER_Field :=
                       Interfaces.NRF52.QDEC.Val_128US;
      --  unspecified
   ...
   type REPORTPER_Register is record
      ...
      REPORTPER     : REPORTPER_REPORTPER_Field :=
                       Interfaces.NRF52.QDEC.Val_10Smpl;
      --  unspecified
      Reserved_4_31 : Interfaces.NRF52.UInt28 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   subtype LED_PSEL_PIN_Field is Interfaces.NRF52.UInt5;
   subtype LED_PSEL_PORT_Field is Interfaces.NRF52.Bit;
   ...
   type LED_PSEL_Register is record
      ...
      --  Connection
      CONNECT       : LED_CONNECT_Field := Interfaces.NRF52.QDEC.Disconnected;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype A_PSEL_PIN_Field is Interfaces.NRF52.UInt5;
   subtype A_PSEL_PORT_Field is Interfaces.NRF52.Bit;
   ...
   type A_PSEL_Register is record
      ...
      Reserved_6_30 : Interfaces.NRF52.UInt25 := 16#1FFFFFF#;
      --  Connection
      CONNECT       : A_CONNECT_Field := Interfaces.NRF52.QDEC.Disconnected;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype B_PSEL_PIN_Field is Interfaces.NRF52.UInt5;
   subtype B_PSEL_PORT_Field is Interfaces.NRF52.Bit;
   ...
   type B_PSEL_Register is record
      ...
      Reserved_6_30 : Interfaces.NRF52.UInt25 := 16#1FFFFFF#;
      --  Connection
      CONNECT       : B_CONNECT_Field := Interfaces.NRF52.QDEC.Disconnected;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type DBFEN_Register is record
      --  Enable input debounce filters
      DBFEN         : DBFEN_DBFEN_Field := Interfaces.NRF52.QDEC.Disabled;
      --  unspecified
      Reserved_1_31 : Interfaces.NRF52.UInt31 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   subtype LEDPRE_LEDPRE_Field is Interfaces.NRF52.UInt9;
   ...
   subtype ACCDBL_ACCDBL_Field is Interfaces.NRF52.UInt4;
   ...
   subtype ACCDBLREAD_ACCDBLREAD_Field is Interfaces.NRF52.UInt4;
   ...
   type QDEC_Peripheral is record
      ...
      TASKS_READCLRACC : aliased Interfaces.NRF52.UInt32;
      --  Read and clear ACC
      TASKS_RDCLRACC   : aliased Interfaces.NRF52.UInt32;
      --  Read and clear ACCDBL
      TASKS_RDCLRDBL   : aliased Interfaces.NRF52.UInt32;
      --  Event being generated for every new sample value written to the
      --  SAMPLE register
      EVENTS_SAMPLERDY : aliased Interfaces.NRF52.UInt32;
      --  Non-null report ready
      EVENTS_REPORTRDY : aliased Interfaces.NRF52.UInt32;
      --  ACC or ACCDBL register overflow
      EVENTS_ACCOF     : aliased Interfaces.NRF52.UInt32;
      --  Double displacement(s) detected
      EVENTS_DBLRDY    : aliased Interfaces.NRF52.UInt32;
