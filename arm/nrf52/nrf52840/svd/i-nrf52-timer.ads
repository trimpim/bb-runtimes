...
package Interfaces.NRF52.TIMER is
   pragma Preelaborate;
   ...
   --  Description collection[0]: Capture Timer value to CC[0] register
   type TASKS_CAPTURE_Registers is array (0 .. 5) of Interfaces.NRF52.UInt32
     with Volatile;

   --  Description collection[0]: Compare event on CC[0] match

   --  Description collection[0]: Compare event on CC[0] match
   type EVENTS_COMPARE_Registers is array (0 .. 5) of Interfaces.NRF52.UInt32
     with Volatile;
   ...
   type SHORTS_Register is record
      ...
      COMPARE0_CLEAR : SHORTS_COMPARE0_CLEAR_Field :=
                        Interfaces.NRF52.TIMER.Disabled;
      --  Shortcut between COMPARE[1] event and CLEAR task
   ...
   type INTENSET_Register is record
      --  unspecified
      Reserved_0_15  : Interfaces.NRF52.UInt16 := 16#0#;
      --  Write '1' to Enable interrupt for COMPARE[0] event
   ...
   type MODE_Register is record
      --  Timer mode
      MODE          : MODE_MODE_Field := Interfaces.NRF52.TIMER.Timer;
      --  unspecified
   ...
   type BITMODE_Register is record
      ...
      BITMODE       : BITMODE_BITMODE_Field :=
                       Interfaces.NRF52.TIMER.Val_16Bit;
      --  unspecified
      Reserved_2_31 : Interfaces.NRF52.UInt30 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   subtype PRESCALER_PRESCALER_Field is Interfaces.NRF52.UInt4;
   ...
   --  Description collection[0]: Capture/Compare register 0
   type CC_Registers is array (0 .. 5) of Interfaces.NRF52.UInt32
     with Volatile;
   ...
   type TIMER_Peripheral is record
      ...
      TASKS_COUNT    : aliased Interfaces.NRF52.UInt32;
      --  Clear time
      TASKS_CLEAR    : aliased Interfaces.NRF52.UInt32;
      --  Deprecated register - Shut down timer
      TASKS_SHUTDOWN : aliased Interfaces.NRF52.UInt32;
      --  Description collection[0]: Capture Timer value to CC[0] register
   ...
   TIMER4_Periph : aliased TIMER_Peripheral
     with Import, Address => System'To_Address (16#4001B000#);

end Interfaces.NRF52.TIMER;
