...
package Interfaces.NRF52.MWU is
   pragma Preelaborate;
   ...
   type EVENTS_REGION_Cluster is record
      ...
      WA : aliased Interfaces.NRF52.UInt32;
      --  Description cluster[0]: Read access to region 0 detected
      RA : aliased Interfaces.NRF52.UInt32;
   end record
   ...
   type INTEN_Register is record
      --  Enable or disable interrupt for REGION[0].WA event
      REGION0WA      : INTEN_REGION0WA_Field := Interfaces.NRF52.MWU.Disabled;
      --  Enable or disable interrupt for REGION[0].RA event
      REGION0RA      : INTEN_REGION0RA_Field := Interfaces.NRF52.MWU.Disabled;
      --  Enable or disable interrupt for REGION[1].WA event
      REGION1WA      : INTEN_REGION1WA_Field := Interfaces.NRF52.MWU.Disabled;
      --  Enable or disable interrupt for REGION[1].RA event
      REGION1RA      : INTEN_REGION1RA_Field := Interfaces.NRF52.MWU.Disabled;
      --  Enable or disable interrupt for REGION[2].WA event
      REGION2WA      : INTEN_REGION2WA_Field := Interfaces.NRF52.MWU.Disabled;
      --  Enable or disable interrupt for REGION[2].RA event
      REGION2RA      : INTEN_REGION2RA_Field := Interfaces.NRF52.MWU.Disabled;
      --  Enable or disable interrupt for REGION[3].WA event
      REGION3WA      : INTEN_REGION3WA_Field := Interfaces.NRF52.MWU.Disabled;
      --  Enable or disable interrupt for REGION[3].RA event
      REGION3RA      : INTEN_REGION3RA_Field := Interfaces.NRF52.MWU.Disabled;
      --  unspecified
      Reserved_8_23  : Interfaces.NRF52.UInt16 := 16#0#;
      --  Enable or disable interrupt for PREGION[0].WA event
      PREGION0WA     : INTEN_PREGION0WA_Field :=
                        Interfaces.NRF52.MWU.Disabled;
      --  Enable or disable interrupt for PREGION[0].RA event
      PREGION0RA     : INTEN_PREGION0RA_Field :=
                        Interfaces.NRF52.MWU.Disabled;
      --  Enable or disable interrupt for PREGION[1].WA event
      PREGION1WA     : INTEN_PREGION1WA_Field :=
                        Interfaces.NRF52.MWU.Disabled;
      --  Enable or disable interrupt for PREGION[1].RA event
      PREGION1RA     : INTEN_PREGION1RA_Field :=
                        Interfaces.NRF52.MWU.Disabled;
      --  unspecified
   ...
   type NMIEN_Register is record
      --  Enable or disable non-maskable interrupt for REGION[0].WA event
      REGION0WA      : NMIEN_REGION0WA_Field := Interfaces.NRF52.MWU.Disabled;
      --  Enable or disable non-maskable interrupt for REGION[0].RA event
      REGION0RA      : NMIEN_REGION0RA_Field := Interfaces.NRF52.MWU.Disabled;
      --  Enable or disable non-maskable interrupt for REGION[1].WA event
      REGION1WA      : NMIEN_REGION1WA_Field := Interfaces.NRF52.MWU.Disabled;
      --  Enable or disable non-maskable interrupt for REGION[1].RA event
      REGION1RA      : NMIEN_REGION1RA_Field := Interfaces.NRF52.MWU.Disabled;
      --  Enable or disable non-maskable interrupt for REGION[2].WA event
      REGION2WA      : NMIEN_REGION2WA_Field := Interfaces.NRF52.MWU.Disabled;
      --  Enable or disable non-maskable interrupt for REGION[2].RA event
      REGION2RA      : NMIEN_REGION2RA_Field := Interfaces.NRF52.MWU.Disabled;
      --  Enable or disable non-maskable interrupt for REGION[3].WA event
      REGION3WA      : NMIEN_REGION3WA_Field := Interfaces.NRF52.MWU.Disabled;
      --  Enable or disable non-maskable interrupt for REGION[3].RA event
      REGION3RA      : NMIEN_REGION3RA_Field := Interfaces.NRF52.MWU.Disabled;
      --  unspecified
      Reserved_8_23  : Interfaces.NRF52.UInt16 := 16#0#;
      --  Enable or disable non-maskable interrupt for PREGION[0].WA event
      PREGION0WA     : NMIEN_PREGION0WA_Field :=
                        Interfaces.NRF52.MWU.Disabled;
      --  Enable or disable non-maskable interrupt for PREGION[0].RA event
      PREGION0RA     : NMIEN_PREGION0RA_Field :=
                        Interfaces.NRF52.MWU.Disabled;
      --  Enable or disable non-maskable interrupt for PREGION[1].WA event
      PREGION1WA     : NMIEN_PREGION1WA_Field :=
                        Interfaces.NRF52.MWU.Disabled;
      --  Enable or disable non-maskable interrupt for PREGION[1].RA event
      PREGION1RA     : NMIEN_PREGION1RA_Field :=
                        Interfaces.NRF52.MWU.Disabled;
      --  unspecified
      Reserved_28_31 : Interfaces.NRF52.UInt4 := 16#0#;
   end record
   ...
   type REGIONEN_Register is record
      --  Enable/disable write access watch in region[0]
      RGN0WA         : REGIONEN_RGN0WA_Field := Interfaces.NRF52.MWU.Disable;
      --  Enable/disable read access watch in region[0]
      RGN0RA         : REGIONEN_RGN0RA_Field := Interfaces.NRF52.MWU.Disable;
      --  Enable/disable write access watch in region[1]
      RGN1WA         : REGIONEN_RGN1WA_Field := Interfaces.NRF52.MWU.Disable;
      --  Enable/disable read access watch in region[1]
      RGN1RA         : REGIONEN_RGN1RA_Field := Interfaces.NRF52.MWU.Disable;
      --  Enable/disable write access watch in region[2]
      RGN2WA         : REGIONEN_RGN2WA_Field := Interfaces.NRF52.MWU.Disable;
      --  Enable/disable read access watch in region[2]
      RGN2RA         : REGIONEN_RGN2RA_Field := Interfaces.NRF52.MWU.Disable;
      --  Enable/disable write access watch in region[3]
      RGN3WA         : REGIONEN_RGN3WA_Field := Interfaces.NRF52.MWU.Disable;
      --  Enable/disable read access watch in region[3]
      RGN3RA         : REGIONEN_RGN3RA_Field := Interfaces.NRF52.MWU.Disable;
      --  unspecified
      Reserved_8_23  : Interfaces.NRF52.UInt16 := 16#0#;
      --  Enable/disable write access watch in PREGION[0]
      PRGN0WA        : REGIONEN_PRGN0WA_Field := Interfaces.NRF52.MWU.Disable;
      --  Enable/disable read access watch in PREGION[0]
      PRGN0RA        : REGIONEN_PRGN0RA_Field := Interfaces.NRF52.MWU.Disable;
      --  Enable/disable write access watch in PREGION[1]
      PRGN1WA        : REGIONEN_PRGN1WA_Field := Interfaces.NRF52.MWU.Disable;
      --  Enable/disable read access watch in PREGION[1]
      PRGN1RA        : REGIONEN_PRGN1RA_Field := Interfaces.NRF52.MWU.Disable;
      --  unspecified
      Reserved_28_31 : Interfaces.NRF52.UInt4 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   type REGION_Cluster is record
      ...
      START : aliased Interfaces.NRF52.UInt32;
      --  Description cluster[0]: End address of region 0
      END_k : aliased Interfaces.NRF52.UInt32;
