...
package Interfaces.NRF52.LPCOMP is
   pragma Preelaborate;
   ...
   type SHORTS_Register is record
      ...
      READY_SAMPLE  : SHORTS_READY_SAMPLE_Field :=
                       Interfaces.NRF52.LPCOMP.Disabled;
      --  Shortcut between READY event and STOP task
   ...
   type ENABLE_Register is record
      --  Enable or disable LPCOMP
      ENABLE        : ENABLE_ENABLE_Field := Interfaces.NRF52.LPCOMP.Disabled;
      --  unspecified
   ...
   type PSEL_Register is record
      --  Analog pin select
      PSEL          : PSEL_PSEL_Field := Interfaces.NRF52.LPCOMP.Analoginput0;
      --  unspecified
   ...
   type REFSEL_Register is record
      ...
      REFSEL        : REFSEL_REFSEL_Field :=
                       Interfaces.NRF52.LPCOMP.Ref5_8Vdd;
      --  unspecified
      Reserved_4_31 : Interfaces.NRF52.UInt28 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   type EXTREFSEL_Register is record
      ...
      EXTREFSEL     : EXTREFSEL_EXTREFSEL_Field :=
                       Interfaces.NRF52.LPCOMP.Analogreference0;
      --  unspecified
   ...
   type ANADETECT_Register is record
      --  Analog detect configuration
      ANADETECT     : ANADETECT_ANADETECT_Field :=
                       Interfaces.NRF52.LPCOMP.Cross;
      --  unspecified
      Reserved_2_31 : Interfaces.NRF52.UInt30 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   type HYST_Register is record
      --  Comparator hysteresis enable
      HYST          : HYST_HYST_Field := Interfaces.NRF52.LPCOMP.Disabled;
      --  unspecified
      Reserved_1_31 : Interfaces.NRF52.UInt31 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
