...
package Interfaces.NRF52.SAADC is
   pragma Preelaborate;
   ...
   type EVENTS_CH_Cluster is record
      ...
      --  CH[0].LIMIT.HIGH
      LIMITH : aliased Interfaces.NRF52.UInt32;
      --  Description cluster[0]: Last results is equal or below
      --  CH[0].LIMIT.LOW
      LIMITL : aliased Interfaces.NRF52.UInt32;
   end record
   ...
   type INTEN_Register is record
      --  Enable or disable interrupt for STARTED event
      STARTED        : INTEN_STARTED_Field := Interfaces.NRF52.SAADC.Disabled;
      --  Enable or disable interrupt for END event
      END_k          : INTEN_END_Field := Interfaces.NRF52.SAADC.Disabled;
      --  Enable or disable interrupt for DONE event
      DONE           : INTEN_DONE_Field := Interfaces.NRF52.SAADC.Disabled;
      --  Enable or disable interrupt for RESULTDONE event
      RESULTDONE     : INTEN_RESULTDONE_Field :=
                        Interfaces.NRF52.SAADC.Disabled;
      --  Enable or disable interrupt for CALIBRATEDONE event
      CALIBRATEDONE  : INTEN_CALIBRATEDONE_Field :=
                        Interfaces.NRF52.SAADC.Disabled;
      --  Enable or disable interrupt for STOPPED event
      STOPPED        : INTEN_STOPPED_Field := Interfaces.NRF52.SAADC.Disabled;
      --  Enable or disable interrupt for CH[0].LIMITH event
      CH0LIMITH      : INTEN_CH0LIMITH_Field :=
                        Interfaces.NRF52.SAADC.Disabled;
      --  Enable or disable interrupt for CH[0].LIMITL event
      CH0LIMITL      : INTEN_CH0LIMITL_Field :=
                        Interfaces.NRF52.SAADC.Disabled;
      --  Enable or disable interrupt for CH[1].LIMITH event
      CH1LIMITH      : INTEN_CH1LIMITH_Field :=
                        Interfaces.NRF52.SAADC.Disabled;
      --  Enable or disable interrupt for CH[1].LIMITL event
      CH1LIMITL      : INTEN_CH1LIMITL_Field :=
                        Interfaces.NRF52.SAADC.Disabled;
      --  Enable or disable interrupt for CH[2].LIMITH event
      CH2LIMITH      : INTEN_CH2LIMITH_Field :=
                        Interfaces.NRF52.SAADC.Disabled;
      --  Enable or disable interrupt for CH[2].LIMITL event
      CH2LIMITL      : INTEN_CH2LIMITL_Field :=
                        Interfaces.NRF52.SAADC.Disabled;
      --  Enable or disable interrupt for CH[3].LIMITH event
      CH3LIMITH      : INTEN_CH3LIMITH_Field :=
                        Interfaces.NRF52.SAADC.Disabled;
      --  Enable or disable interrupt for CH[3].LIMITL event
      CH3LIMITL      : INTEN_CH3LIMITL_Field :=
                        Interfaces.NRF52.SAADC.Disabled;
      --  Enable or disable interrupt for CH[4].LIMITH event
      CH4LIMITH      : INTEN_CH4LIMITH_Field :=
                        Interfaces.NRF52.SAADC.Disabled;
      --  Enable or disable interrupt for CH[4].LIMITL event
      CH4LIMITL      : INTEN_CH4LIMITL_Field :=
                        Interfaces.NRF52.SAADC.Disabled;
      --  Enable or disable interrupt for CH[5].LIMITH event
      CH5LIMITH      : INTEN_CH5LIMITH_Field :=
                        Interfaces.NRF52.SAADC.Disabled;
      --  Enable or disable interrupt for CH[5].LIMITL event
      CH5LIMITL      : INTEN_CH5LIMITL_Field :=
                        Interfaces.NRF52.SAADC.Disabled;
      --  Enable or disable interrupt for CH[6].LIMITH event
      CH6LIMITH      : INTEN_CH6LIMITH_Field :=
                        Interfaces.NRF52.SAADC.Disabled;
      --  Enable or disable interrupt for CH[6].LIMITL event
      CH6LIMITL      : INTEN_CH6LIMITL_Field :=
                        Interfaces.NRF52.SAADC.Disabled;
      --  Enable or disable interrupt for CH[7].LIMITH event
      CH7LIMITH      : INTEN_CH7LIMITH_Field :=
                        Interfaces.NRF52.SAADC.Disabled;
      --  Enable or disable interrupt for CH[7].LIMITL event
      CH7LIMITL      : INTEN_CH7LIMITL_Field :=
                        Interfaces.NRF52.SAADC.Disabled;
      --  unspecified
   ...
   type ENABLE_Register is record
      --  Enable or disable ADC
      ENABLE        : ENABLE_ENABLE_Field := Interfaces.NRF52.SAADC.Disabled;
      --  unspecified
   ...
   type PSELP_CH_Register is record
      --  Analog positive input channel
      PSELP         : PSELP_PSELP_Field := Interfaces.NRF52.SAADC.Nc;
      --  unspecified
   ...
   type PSELN_CH_Register is record
      --  Analog negative input, enables differential channel
      PSELN         : PSELN_PSELN_Field := Interfaces.NRF52.SAADC.Nc;
      --  unspecified
      Reserved_5_31 : Interfaces.NRF52.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   type CONFIG_CH_Register is record
      --  Positive channel resistor control
      RESP           : CONFIG_RESP_Field := Interfaces.NRF52.SAADC.Bypass;
      --  unspecified
      Reserved_2_3   : Interfaces.NRF52.UInt2 := 16#0#;
      --  Negative channel resistor control
      RESN           : CONFIG_RESN_Field := Interfaces.NRF52.SAADC.Bypass;
      --  unspecified
      Reserved_6_7   : Interfaces.NRF52.UInt2 := 16#0#;
      --  Gain control
      GAIN           : CONFIG_GAIN_Field := Interfaces.NRF52.SAADC.Gain1_6;
      --  unspecified
      Reserved_11_11 : Interfaces.NRF52.Bit := 16#0#;
      --  Reference control
      REFSEL         : CONFIG_REFSEL_Field := Interfaces.NRF52.SAADC.Internal;
      --  unspecified
      Reserved_13_15 : Interfaces.NRF52.UInt3 := 16#0#;
      --  Acquisition time, the time the ADC uses to sample the input voltage
      TACQ           : CONFIG_TACQ_Field := Interfaces.NRF52.SAADC.Val_10US;
      --  unspecified
      Reserved_19_19 : Interfaces.NRF52.Bit := 16#0#;
      --  Enable differential mode
      MODE           : CONFIG_MODE_Field := Interfaces.NRF52.SAADC.Se;
      --  unspecified
      Reserved_21_23 : Interfaces.NRF52.UInt3 := 16#0#;
      --  Enable burst mode
      BURST          : CONFIG_BURST_Field := Interfaces.NRF52.SAADC.Disabled;
      --  unspecified
   ...
   subtype LIMIT_CH_LOW_Field is Interfaces.NRF52.UInt16;
   subtype LIMIT_CH_HIGH_Field is Interfaces.NRF52.UInt16;
   ...
   type RESOLUTION_Register is record
      --  Set the resolution
      VAL           : RESOLUTION_VAL_Field :=
                       Interfaces.NRF52.SAADC.Val_10BIT;
      --  unspecified
   ...
   subtype SAMPLERATE_CC_Field is Interfaces.NRF52.UInt11;
   ...
   type SAMPLERATE_Register is record
      ...
      Reserved_11_11 : Interfaces.NRF52.Bit := 16#0#;
      --  Select mode for sample rate control
      MODE           : SAMPLERATE_MODE_Field := Interfaces.NRF52.SAADC.Task_k;
      --  unspecified
   ...
   subtype MAXCNT_RESULT_MAXCNT_Field is Interfaces.NRF52.UInt15;
   ...
   subtype AMOUNT_RESULT_AMOUNT_Field is Interfaces.NRF52.UInt15;
   ...
   type AMOUNT_RESULT_Register is record
      ...
      --  unspecified
      Reserved_15_31 : Interfaces.NRF52.UInt17;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type SAADC_Peripheral is record
      ...
      TASKS_CALIBRATEOFFSET : aliased Interfaces.NRF52.UInt32;
      --  The ADC has started
      ...
      EVENTS_RESULTDONE     : aliased Interfaces.NRF52.UInt32;
      --  Calibration is complete
      EVENTS_CALIBRATEDONE  : aliased Interfaces.NRF52.UInt32;
      --  The ADC has stopped
