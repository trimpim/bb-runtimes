...
package Interfaces.NRF52.GPIO is
   ...
   type PIN_CNF_DRIVE_Field is
     (
      ...
      D0S1,
      --  Disconnect '0', high drive '1' (normally used for wired-or
      --  connections)
      D0H1,
      --  Standard '0'. disconnect '1' (normally used for wired-and
      --  connections)
      S0D1,
      --  High drive '0', disconnect '1' (normally used for wired-and
      --  connections)
      H0D1)
     with Size => 3;
