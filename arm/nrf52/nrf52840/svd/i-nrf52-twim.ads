...
package Interfaces.NRF52.TWIM is
   pragma Preelaborate;
   ...
   type SHORTS_Register is record
      --  unspecified
      Reserved_0_6   : Interfaces.NRF52.UInt7 := 16#0#;
      --  Shortcut between LASTTX event and STARTRX task
      LASTTX_STARTRX : SHORTS_LASTTX_STARTRX_Field :=
                        Interfaces.NRF52.TWIM.Disabled;
      --  Shortcut between LASTTX event and SUSPEND task
      LASTTX_SUSPEND : SHORTS_LASTTX_SUSPEND_Field :=
                        Interfaces.NRF52.TWIM.Disabled;
      --  Shortcut between LASTTX event and STOP task
      LASTTX_STOP    : SHORTS_LASTTX_STOP_Field :=
                        Interfaces.NRF52.TWIM.Disabled;
      --  Shortcut between LASTRX event and STARTTX task
      ...
      --  Shortcut between LASTRX event and STOP task
      LASTRX_STOP    : SHORTS_LASTRX_STOP_Field :=
                        Interfaces.NRF52.TWIM.Disabled;
      --  unspecified
   ...
   type INTEN_Register is record
      ...
      --  Enable or disable interrupt for STOPPED event
      STOPPED        : INTEN_STOPPED_Field := Interfaces.NRF52.TWIM.Disabled;
      --  unspecified
      Reserved_2_8   : Interfaces.NRF52.UInt7 := 16#0#;
      --  Enable or disable interrupt for ERROR event
      ERROR          : INTEN_ERROR_Field := Interfaces.NRF52.TWIM.Disabled;
      --  unspecified
      Reserved_10_17 : Interfaces.NRF52.Byte := 16#0#;
      --  Enable or disable interrupt for SUSPENDED event
      SUSPENDED      : INTEN_SUSPENDED_Field :=
                        Interfaces.NRF52.TWIM.Disabled;
      --  Enable or disable interrupt for RXSTARTED event
      ...
      TXSTARTED      : INTEN_TXSTARTED_Field :=
                        Interfaces.NRF52.TWIM.Disabled;
      --  unspecified
      Reserved_21_22 : Interfaces.NRF52.UInt2 := 16#0#;
      --  Enable or disable interrupt for LASTRX event
      LASTRX         : INTEN_LASTRX_Field := Interfaces.NRF52.TWIM.Disabled;
      --  Enable or disable interrupt for LASTTX event
      LASTTX         : INTEN_LASTTX_Field := Interfaces.NRF52.TWIM.Disabled;
      --  unspecified
   ...
   type ERRORSRC_Register is record
      ...
      OVERRUN       : ERRORSRC_OVERRUN_Field :=
                       Interfaces.NRF52.TWIM.Notreceived;
      --  NACK received after sending the address (write '1' to clear)
      ANACK         : ERRORSRC_ANACK_Field :=
                       Interfaces.NRF52.TWIM.Notreceived;
      --  NACK received after sending a data byte (write '1' to clear)
   ...
   type ENABLE_Register is record
      --  Enable or disable TWIM
      ENABLE        : ENABLE_ENABLE_Field := Interfaces.NRF52.TWIM.Disabled;
      --  unspecified
   ...
   type SCL_PSEL_Register is record
      ...
      --  Connection
      CONNECT       : SCL_CONNECT_Field := Interfaces.NRF52.TWIM.Disconnected;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type SDA_PSEL_Register is record
      ...
      Reserved_6_30 : Interfaces.NRF52.UInt25 := 16#1FFFFFF#;
      --  Connection
      CONNECT       : SDA_CONNECT_Field := Interfaces.NRF52.TWIM.Disconnected;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type LIST_RXD_Register is record
      --  List type
      LIST          : LIST_LIST_Field := Interfaces.NRF52.TWIM.Disabled;
      --  unspecified
      Reserved_3_31 : Interfaces.NRF52.UInt29 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   type TWIM_Peripheral is record
      ...
      EVENTS_LASTRX    : aliased Interfaces.NRF52.UInt32;
      --  Byte boundary, starting to transmit the last byte
      EVENTS_LASTTX    : aliased Interfaces.NRF52.UInt32;
      --  Shortcut register
