...
--  This package defines board parameters for the nRF52840 board
...
package System.BB.Board_Parameters is
   ...
   --  Optimal frequency of the system clock. Note that the nRF52840 can go
   --  up to 200 MHz, but all other NRF528xx MCUs can only do
   --  168 MHz.
